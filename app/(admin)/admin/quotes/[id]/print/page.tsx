    ...
    <>
      ...
      <div className="min-h-screen bg-[#faf8f5] text-zinc-900 antialiased print:min-h-0 print:bg-white">
        <article className="mx-auto max-w-[48rem] px-5 py-8 print:max-w-none print:px-0 print:py-0 sm:px-8 sm:py-10">
          ...
          <div className="mt-8 grid gap-5 print:mt-5 print:gap-4 sm:grid-cols-2 sm:gap-6">
            <section
              className="rounded-xl border border-zinc-200/80 p-5 shadow-sm print:border-zinc-300 print:p-4 print:shadow-none"
            ...
            <section className="rounded-xl border border-zinc-200/80 bg-white p-5 shadow-sm print:border-zinc-300 print:p-4 print:shadow-none">
          ...
          {!merged.hideLineItems && (
            <section className="mt-10 print:mt-6">
                ...
                <table className="w-full border-collapse text-sm print:text-xs">
                  <thead>
                    <tr className="bg-zinc-100 text-left text-zinc-700 print:bg-zinc-100">
                      <th className="px-4 py-3 text-[0.65rem] font-bold uppercase tracking-wider print:px-3 print:py-2">
                        Description
                      </th>
                      <th className="w-16 px-2 py-3 text-right text-[0.65rem] font-bold uppercase tracking-wider print:py-2">
                        Qty
                      </th>
                      <th className="w-28 px-2 py-3 text-right text-[0.65rem] font-bold uppercase tracking-wider print:py-2">
                        Unit
                      </th>
                      <th className="w-28 px-4 py-3 text-right text-[0.65rem] font-bold uppercase tracking-wider print:px-3 print:py-2">
                        Total
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {merged.items.map((item, i) => (
                      <tr key={i} className="border-t border-zinc-100 bg-white">
                        <td className="px-4 py-3.5 align-top leading-snug text-zinc-800 print:px-3 print:py-2">
                          {item.description}
                        </td>
                        <td className="px-2 py-3.5 text-right tabular-nums text-zinc-700 print:py-2">{item.qty}</td>
                        <td className="px-2 py-3.5 text-right tabular-nums text-zinc-700 print:py-2">
                          {formatCents(item.unit_price_cents)}
                        </td>
                        <td className="px-4 py-3.5 text-right tabular-nums font-semibold text-zinc-900 print:px-3 print:py-2">
              ...
              <div className="mt-6 flex justify-end print:mt-4 print:break-inside-avoid">
                <div
                  className="w-full max-w-xs space-y-2 rounded-xl border border-zinc-200 border-t-4 bg-white px-6 py-4 text-sm print:border-zinc-300 print:px-5 print:py-3"
          ...
          {merged.footerNote && (
            <p className="mt-8 rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-3 text-center text-sm text-zinc-700 print:mt-5 print:break-inside-avoid">
              {merged.footerNote}
            </p>
          )}
          </div>
