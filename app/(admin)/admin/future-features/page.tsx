      ...
      <section className="rounded-xl border border-border bg-card overflow-hidden shadow-sm">
        <div className="border-b border-border bg-muted/30 px-4 py-3 sm:px-5">
          ...
          <p className="mt-0.5 text-sm text-muted-foreground">
            Optional eSignature workflow for work orders, contracts, and change orders.
          </p>
        </div>
        <div className="p-4 sm:p-5 space-y-2">
          <p className="text-sm text-foreground">
            <strong>Planned:</strong> Enable staff to generate and send internal customer documents for eSignature from within the job and invoice workflows.
          </p>
          <p className="text-xs text-muted-foreground">
            Future: standardized templates for work orders, estimates, contracts, and approvals.
          </p>
        </div>
      </section>
