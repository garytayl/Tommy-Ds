  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col gap-6 p-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <a
          href="/admin"
          className="rounded-lg border bg-white p-4 text-zinc-900 hover:bg-zinc-50"
        >
          <h2 className="font-semibold text-zinc-900">Admin Dashboard</h2>
          <p className="text-sm text-zinc-600">
        ...
        <a
          ...
          className="rounded-lg border bg-white p-4 text-zinc-900 hover:bg-zinc-50"
        >
          <h2 className="font-semibold text-zinc-900">Installer Mobile View</h2>
          <p className="text-sm text-zinc-600">
