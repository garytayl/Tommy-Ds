...
const jobs = [
  ...
  { id: "a2000001-0000-4000-8000-000000000002", customer_id: CUSTOMER_IDS[1], title: "Garage door repair", address_line1: "456 Elm Ave", address_line2: "Unit B", city: "Indianapolis", state: "IN", zip: "46202", scheduled_start: addHours(addDays(now, 3), 10), scheduled_end: addHours(addDays(now, 3), 11), status: "scheduled", notes: null, job_kind: "service" },
  { id: "a2000001-0000-4000-8000-000000000003", customer_id: CUSTOMER_IDS[2], title: "Commercial entry doors x4", address_line1: "789 Commerce Dr", address_line2: null, city: "Indianapolis", state: "IN", zip: "46203", scheduled_start: addHours(addDays(now, 5), 8), scheduled_end: addHours(addDays(now, 5), 14), status: "lead", notes: "Send quote first.", job_kind: "installation" },
  { id: "a2000001-0000-4000-8000-000000000004", customer_id: CUSTOMER_IDS[3], title: "Sliding patio door", address_line1: "321 Maple Ln", address_line2: null, city: "Carmel", state: "IN", zip: "46032", scheduled_start: addHours(addDays(now, -1), 9), scheduled_end: addHours(addDays(now, -1), 12), status: "completed", notes: "Left key with neighbor.", job_kind: "installation" },
  { id: "a2000001-0000-4000-8000-000000000005", customer_id: CUSTOMER_IDS[4], title: "Window + door package", address_line1: "555 Realtor Way", address_line2: null, city: "Fishers", state: "IN", zip: "46038", scheduled_start: addHours(addDays(now, -3), 8), scheduled_end: addHours(addDays(now, -3), 12), status: "paid", notes: null, job_kind: "installation" },
  { id: "a2000001-0000-4000-8000-000000000006", customer_id: CUSTOMER_IDS[0], title: "Storm door install", address_line1: "123 Oak St", address_line2: null, city: "Indianapolis", state: "IN", zip: "46201", scheduled_start: addHours(addDays(now, 7), 10), scheduled_end: addHours(addDays(now, 7), 11), status: "lead", notes: "Follow-up from front door job.", job_kind: "installation" },
  { id: "a2000001-0000-4000-8000-000000000007", customer_id: CUSTOMER_IDS[5], title: "Garage door opener", address_line1: "100 Main St", address_line2: null, city: "Noblesville", state: "IN", zip: "46060", scheduled_start: addHours(addDays(now, 4), 9), scheduled_end: addHours(addDays(now, 4), 11), status: "scheduled", notes: null, job_kind: "service" },
  { id: "a2000001-0000-4000-8000-000000000008", customer_id: CUSTOMER_IDS[6], title: "Clubhouse double doors", address_line1: "200 HOA Blvd", address_line2: null, city: "Indianapolis", state: "IN", zip: "46204", scheduled_start: null, scheduled_end: null, status: "lead", notes: "Waiting on HOA approval.", job_kind: "installation" },
  { id: "a2000001-0000-4000-8000-000000000009", customer_id: CUSTOMER_IDS[7], title: "Back door + frame", address_line1: "888 Harris Rd", address_line2: null, city: "Greenwood", state: "IN", zip: "46142", scheduled_start: addHours(addDays(now, 1), 10), scheduled_end: addHours(addDays(now, 1), 12), status: "scheduled", notes: "Dog in yard, use side gate.", job_kind: "installation" },
  { id: "a2000001-0000-4000-8000-00000000000a", customer_id: CUSTOMER_IDS[8], title: "Office building entry", address_line1: "500 Business Park", address_line2: null, city: "Indianapolis", state: "IN", zip: "46205", scheduled_start: addHours(addDays(now, -5), 8), scheduled_end: addHours(addDays(now, -5), 16), status: "completed", notes: null, job_kind: "installation" },
  { id: "a2000001-0000-4000-8000-00000000000b", customer_id: CUSTOMER_IDS[9], title: "Rental unit door repair", address_line1: "777 Landlord Ln", address_line2: "Apt 2", city: "Indianapolis", state: "IN", zip: "46206", scheduled_start: addHours(addDays(now, -2), 14), scheduled_end: addHours(addDays(now, -2), 15), status: "in_progress", notes: "Tenant present.", job_kind: "service" },
  { id: "a2000001-0000-4000-8000-00000000000c", customer_id: CUSTOMER_IDS[1], title: "Basement egress window", address_line1: "456 Elm Ave", address_line2: null, city: "Indianapolis", state: "IN", zip: "46202", scheduled_start: addHours(addDays(now, 6), 9), scheduled_end: null, status: "lead", notes: null, job_kind: "installation" },
  { id: "a2000001-0000-4000-8000-00000000000d", customer_id: CUSTOMER_IDS[3], title: "Second property - garage", address_line1: "999 Rental Pl", address_line2: null, city: "Carmel", state: "IN", zip: "46032", scheduled_start: addHours(addDays(now, -7), 10), scheduled_end: addHours(addDays(now, -7), 12), status: "paid", notes: null, job_kind: "installation" },
  { id: "a2000001-0000-4000-8000-00000000000e", customer_id: CUSTOMER_IDS[4], title: "New construction - 3 doors", address_line1: "100 New Build Dr", address_line2: null, city: "Fishers", state: "IN", zip: "46038", scheduled_start: addHours(addDays(now, 14), 8), scheduled_end: addHours(addDays(now, 14), 13), status: "lead", notes: "Builder will provide specs.", job_kind: "installation" },
  { id: "a2000001-0000-4000-8000-00000000000f", customer_id: CUSTOMER_IDS[6], title: "Pool gate latch", address_line1: "200 HOA Blvd", address_line2: "Pool area", city: "Indianapolis", state: "IN", zip: "46204", scheduled_start: addHours(addDays(now, 3), 11), scheduled_end: addHours(addDays(now, 3), 11.5), status: "scheduled", notes: "Quick fix.", job_kind: "service" },
];
