...
INSERT INTO public.jobs (id, customer_id, title, address_line1, address_line2, city, state, zip, scheduled_start, scheduled_end, status, notes) VALUES
  ('a2000001-0000-4000-8000-000000000001', 'c1000001-0000-4000-8000-000000000001', 'Front door replacement', '123 Oak St', NULL, 'Indianapolis', 'IN', '46201', NOW() + INTERVAL '2 days', NOW() + INTERVAL '2 days' + INTERVAL '2 hours', 'scheduled', 'Customer prefers morning slot.'),
  ('a2000001-0000-4000-8000-000000000002', 'c1000001-0000-4000-8000-000000000002', 'Garage door repair', '456 Elm Ave', 'Unit B', 'Indianapolis', 'IN', '46202', NOW() + INTERVAL '3 days', NOW() + INTERVAL '3 days' + INTERVAL '1 hour', 'scheduled', NULL),
  ('a2000001-0000-4000-8000-000000000003', 'c1000001-0000-4000-8000-000000000003', 'Commercial entry doors x4', '789 Commerce Dr', NULL, 'Indianapolis', 'IN', '46203', NOW() + INTERVAL '5 days', NOW() + INTERVAL '5 days' + INTERVAL '6 hours', 'lead', 'Send quote first.'),
  ('a2000001-0000-4000-8000-000000000004', 'c1000001-0000-4000-8000-000000000004', 'Sliding patio door', '321 Maple Ln', NULL, 'Carmel', 'IN', '46032', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day' + INTERVAL '3 hours', 'completed', 'Left key with neighbor.'),
  ('a2000001-0000-4000-8000-000000000005', 'c1000001-0000-4000-8000-000000000005', 'Window + door package', '555 Realtor Way', NULL, 'Fishers', 'IN', '46038', NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days' + INTERVAL '4 hours', 'paid', NULL),
  ('a2000001-0000-4000-8000-000000000006', 'c1000001-0000-4000-8000-000000000001', 'Storm door install', '123 Oak St', NULL, 'Indianapolis', 'IN', '46201', NOW() + INTERVAL '1 week', NOW() + INTERVAL '1 week' + INTERVAL '1 hour', 'lead', 'Follow-up from front door job.'),
  ('a2000001-0000-4000-8000-000000000007', 'c1000001-0000-4000-8000-000000000006', 'Garage door opener', '100 Main St', NULL, 'Noblesville', 'IN', '46060', NOW() + INTERVAL '4 days', NOW() + INTERVAL '4 days' + INTERVAL '2 hours', 'scheduled', NULL),
  ('a2000001-0000-4000-8000-000000000008', 'c1000001-0000-4000-8000-000000000007', 'Clubhouse double doors', '200 HOA Blvd', NULL, 'Indianapolis', 'IN', '46204', NULL, NULL, 'lead', 'Waiting on HOA approval.'),
  ('a2000001-0000-4000-8000-000000000009', 'c1000001-0000-4000-8000-000000000008', 'Back door + frame', '888 Harris Rd', NULL, 'Greenwood', 'IN', '46142', NOW() + INTERVAL '1 day', NOW() + INTERVAL '1 day' + INTERVAL '2 hours', 'scheduled', 'Dog in yard, use side gate.'),
  ('a2000001-0000-4000-8000-00000000000a', 'c1000001-0000-4000-8000-000000000009', 'Office building entry', '500 Business Park', NULL, 'Indianapolis', 'IN', '46205', NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days' + INTERVAL '8 hours', 'completed', NULL),
  ('a2000001-0000-4000-8000-00000000000b', 'c1000001-0000-4000-8000-00000000000a', 'Rental unit door repair', '777 Landlord Ln', 'Apt 2', 'Indianapolis', 'IN', '46206', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days' + INTERVAL '1 hour', 'in_progress', 'Tenant present.'),
  ('a2000001-0000-4000-8000-00000000000c', 'c1000001-0000-4000-8000-000000000002', 'Basement egress window', '456 Elm Ave', NULL, 'Indianapolis', 'IN', '46202', NOW() + INTERVAL '6 days', NULL, 'lead', NULL),
  ('a2000001-0000-4000-8000-00000000000d', 'c1000001-0000-4000-8000-000000000004', 'Second property - garage', '999 Rental Pl', NULL, 'Carmel', 'IN', '46032', NOW() - INTERVAL '7 days', NOW() - INTERVAL '7 days' + INTERVAL '2 hours', 'paid', NULL),
  ('a2000001-0000-4000-8000-00000000000e', 'c1000001-0000-4000-8000-000000000005', 'New construction - 3 doors', '100 New Build Dr', NULL, 'Fishers', 'IN', '46038', NOW() + INTERVAL '2 weeks', NOW() + INTERVAL '2 weeks' + INTERVAL '5 hours', 'lead', 'Builder will provide specs.'),
  ('a2000001-0000-4000-8000-00000000000f', 'c1000001-0000-4000-8000-000000000007', 'Pool gate latch', '200 HOA Blvd', 'Pool area', 'Indianapolis', 'IN', '46204', NOW() + INTERVAL '3 days', NOW() + INTERVAL '3 days' + INTERVAL '30 minutes', 'scheduled', 'Quick fix.')
ON CONFLICT (id) DO NOTHING;
